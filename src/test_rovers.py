...
from src.mars_rovers import MarsRover, InvalidInstructiosException
...
class MarsRoverTest(TestCase):
    ...
    def setUp(self):
        ...
        self.rover2 = MarsRover(3, 3, 'S', self.bnd_x, self.bnd_y)
    ...
    def test_rover2_move(self):
        with self.assertRaises(InvalidInstructiosException):
            self.rover2.move('LMLMLMLMMQ')
